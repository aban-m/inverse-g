...
\NewDocumentCommand{\hg}{}{\hold graph}
\NewDocumentCommand{\ghg}{}{generalized \hg}
...
%\emph{Remark.} From Dirichlet's theorem on arithmetic progression see that every directed acyclic graph is the \hg of infinitely many squarefree integers: Ultimately, choosing the next prime in the factorization amounts to finding a prime satisfying some linear congruences modulo primes, and this is always possible.
...
\begin{cor}\thlabel{eustick} Suppose $\Gamma$ is a \hg and $v$ is a disjoint vertex.\listspace
	\begin{enumerate} \listspace
