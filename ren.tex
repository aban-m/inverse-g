...
\begin{itemize}
	...
	\item $\slame$: We get at least $2w_{r - 1}(p) + 2w_{r - 1}(pq) \ge 4$ groups.
...
The graph of $qrs$ is \tikz[ww] \pic {twalk};. At least one prime, say $v$, is connected with $p^2$. We need $g(p^2 v) = 3$, which implies the existence of an arrow $s \dashrightarrow p^2$ by \hthref{euppq}, is equivalent to the existence of an arrow $s \dashrightarrow p^2$.
