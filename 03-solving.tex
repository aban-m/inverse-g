...
We cannot extend $Q$: Both extensions $b \to Q$ and $Q \to f$ give too many groups by \hthref{eustick}.
...
Using \hthref{eustick}, we see that adding a new vertex $v$ and an arrow $u \to v$,
